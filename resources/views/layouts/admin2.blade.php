...
>
  <head>
   ...
   @include('layouts.script.topscript')
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="{{url('/admin/rekapabsensi')}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-crown"></i>
                  <div data-i18n="Boxicons">Rekap Absensi</div>
                </a>
              </li>
           @endrole
   ...
   @include('layouts.script.bottomscript')
  </body>
</html>
